...
const i18n = {
  en: {
    ...
    'nav.tm':           'Toastmasters',
    'nav.venue':        'Venue',
    'nav.champions':    'Das Fenster',
    'nav.chairs':       'Contest Chairs',
    'nav.contest':      'Contest 2026',
    'nav.home':         '← Home',

    'hero.eyebrow':     'Das Fenster · Division News',
    'hero.title':       'Meet our Division<br>Champions',
    'hero.lead':        'Each of these five speakers won their category at the District 95 Division D contest — our division champions across the International Speech, Evaluation, and Table Topics contests, in English and German.',
  ...
  de: {
    ...
    'hero.eyebrow':     'Das Fenster · Division News',
    'hero.title':       'Unsere Division-<br>Sieger',
    'hero.lead':        'Diese fünf Rednerinnen und Redner haben beim Wettbewerb der District 95 Division D jeweils ihre Kategorie gewonnen — unsere Division-Sieger im Internationalen Redewettbewerb, im Bewertungswettbewerb und im Table-Topics-Wettbewerb, auf Englisch und Deutsch.',
